...
namespace Sudoku.NorvigSolver
{
    ...
    public class NorvigSolver : ISudokuSolver
    {
        ...
        public Core.Sudoku Solve(Core.Sudoku s)
        {
            ...
            //Display(Eliminate(GridValuesExtended(strSudoku)));
            
           var result = Search(GridValuesExtended(strSudoku));
    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var hardPuzzle = ".....5.8....6.1.43..........1.5........1.6...3.......553.....61........4.........";
            ...
            Console.WriteLine($"It took {end.Subtract(start).Seconds}.{end.Subtract(start).Milliseconds} seconds to solve SIMPLE puzzle\n");
            ...
            Console.WriteLine($"It took {end.Subtract(start).Seconds}.{end.Subtract(start).Milliseconds} seconds to solve HARD puzzle\n");
            Console.Read();
        }
